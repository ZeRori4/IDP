...
'''
Напишите функцию, которая принимает в качестве аргумента URL, делает к переданному URL GET запрос и возвращает контент
ресурса в формате объекта python. Если ответ говорит, что запрос неуспешен, нужно вывести соответствующую ошибку.
'''
